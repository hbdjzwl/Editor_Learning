...
public:
	...
	FSMEDITOR_API bool CreateConnections(class UFSMGraphNode* PreviousState, class UFSMGraphNode* NextState, FString InTransName);
private:
...
public:
	...
	//设置静态的缘由:让过渡节点和过渡的那个线用同一个颜色
	static FLinearColor StaticGetTransitionNodeColor(bool bIsHovered);

private:
	void PositionBetweenTwoNodesWithOffset(const FGeometry& StartGeom, const FGeometry& EndGeom, int32 NodeIndex, int32 MaxNodes) const;
	FLinearColor GetTransitionColor() const;
};