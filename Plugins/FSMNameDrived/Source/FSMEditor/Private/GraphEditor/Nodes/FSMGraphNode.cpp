...
void SFSMGraphNode::AddPin(const TSharedRef<SGraphPin>& PinToAdd)
{
	...
	RightNodeBox->AddSlot()
		.HAlign(HAlign_Fill)
		.VAlign(VAlign_Fill)
		.FillHeight(1.0f)	//父类的.AutoHeight()
		//.Padding(Settings->GetOutputPinPadding()) 父类的。
		[
			PinToAdd
		];
...
void SFSMGraphNode::GetNodeInfoPopups(FNodeInfoContext* Context, TArray<FGraphInformationPopupInfo>& Popups) const
{
